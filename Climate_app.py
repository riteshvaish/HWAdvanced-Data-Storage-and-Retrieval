...
# Setting up Database connecton
engine = create_engine("sqlite:///Resources/hawaii.sqlite", connect_args={'check_same_thread': False}, echo=True)
Base = automap_base()
Base.prepare(engine, reflect=True)

# create reference to the tables
...
def welcome():
    ...
    return"""<html>
    <h1>Home Page : List of all available API routes </h1>
    <ul>
    <br>
    <li>
    List of precipitations for all periods:
    <br>
    <a href="/api/v1.0/precipitation">/api/v1.0/precipitation</a>
    </li>
    <br>
    <li>
    Link to JSON list of stations :
    <br>
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>
    <li>
    Return a JSON list of tmin, tmax, tavg for the dates in range of start date and end date inclusive '/api/v1.0/&ltstart&gt/&ltend&gt':
    <br>
    Replace &ltstart&gt and &ltend&gt with a date in Year-Month-Day format as following example :
    <br>
    <br>
    <a href="/api/v1.0/2017-01-06/2017-01-12">/api/v1.0/2017-01-06/2017-01-12</a>
    </li>
    <br>
    <li>
    Return a JSON list of tmin, tmax, tavg for the dates greater than or equal to the date provided `/api/v1.0/&ltstart&gt`:
    <br>Replace &ltstart&gt with a date in Year-Month-Day format as following example :
    <br>
    <a href="/api/v1.0/2017-01-03">/api/v1.0/2017-01-03</a>
    </li>
    <br>
    </ul>
    </html>
...
def precipitation():
    # Docstring 
    """Return a list of precipitations for all period"""
